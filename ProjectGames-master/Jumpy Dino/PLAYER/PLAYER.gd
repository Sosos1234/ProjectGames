...
func _ready():
	...
	Signals.connect("PlayerInArea", set_lives)
func _physics_process(delta):
	if Global.globalSkin == 0: #спайдер скин = 0
		anim.hide()
		anim2.show()
		anim3.hide()
		anim4.hide()
	if Global.globalSkin == 1: # луффи = 1
		anim.hide()
		anim2.hide()
		anim3.show()
		anim4.hide()
	if Global.globalSkin == 2: # си-джей = 2
		anim.hide()
		anim2.hide()
		anim3.hide()
		anim4.show()
	if Global.globalSkin == 3: #стандартный = 3
		anim.show()
		anim2.hide()
		anim3.hide()
		anim4.hide()
